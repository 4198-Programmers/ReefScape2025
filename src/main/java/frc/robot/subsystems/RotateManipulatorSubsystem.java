...
public class RotateManipulatorSubsystem extends SubsystemBase {
    ...
    public Command RotateManipulatorCommand() {
        ...
        return runOnce(
            () -> {
                double targetPosition = isRotated ? ManipulatorConstants.INTAKE_ZERO : ManipulatorConstants.INTAKE_ROTATED; // Target position is 90 degrees if not rotated, otherwise 0 degrees
