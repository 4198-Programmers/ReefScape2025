...
public class PoseEstimatorSubsystem extends SubsystemBase {
    ...
    private final PhotonSubsystem photonCamera;
    ...
    PoseEstimatorSubsystem(SwerveSubsystem swerveSubsystem, PhotonSubsystem photonCamera) {
        this.swerveSubsystem = swerveSubsystem;
        this.photonCamera = photonCamera;
        poseEstimator = new SwerveDrivePoseEstimator(Constants.SWERVE_DRIVE_KINEMATICS, stateStdDevs,
                localMeasurementStdDevs, visionMeasurementStdDevs, swerveSubsystem.getPose());
